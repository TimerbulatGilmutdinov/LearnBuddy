            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <t:navItem activity="active" href="${pageContext.request.contextPath}/update" name="About"/>
                        <t:navItem activity="" href="${pageContext.request.contextPath}/update/subjects"
                                   name="Subjects"/>
                    </ul>
                </div>
            </div>
